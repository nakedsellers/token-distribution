...
/**
 * The Naked Sellers token (NAKED) has a fixed supply and restricts the ability
...
contract NakedSellersToken is StandardToken, BurnableToken, Ownable {
    ...
    string  public constant symbol = "NAKED";
    uint8   public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY      = 500000000 * (10 ** uint256(decimals));
    uint256 public constant CROWDSALE_ALLOWANCE =  325000000 * (10 ** uint256(decimals));
    uint256 public constant ADMIN_ALLOWANCE     =  175000000 * (10 ** uint256(decimals));
     ...
     *
     * @param _value    The amount of tokens to burn in mini-NAKED
     */
